...
//	private String tenKhachHang;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnThem)) {
			...
			if (ShareData.isNumeric(txtSoLuong.getText()) == false) {
			...
			try {
				...
				if (sp == null) {
					...
					int luu = chiTietHoaDon.getSoLuong() + removeRowCTHD(sp.getMaSanPham());
					String[] row = { sp.getMaSanPham(), sp.getTenSanPham(), loai, sp.getDonGia() + "", sp.getKichCo(), luu + "", sp.getDonGia()*luu + "" };
					dfModelCTHD.addRow(row);
				}
